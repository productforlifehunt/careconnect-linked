...
<!-- /wp:group --></div>
<!-- /wp:column -->"""
BLOCKS = ["provider70-shell-block.html", "provider70-requests-block.html", "provider70-schedule-block.html", "provider70-earnings-block.html"]
parts = []
for name in BLOCKS:
...
out = os.path.join(BASE, "provider70_payload.json")

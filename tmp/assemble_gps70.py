...
<!-- /wp:group --></div>
<!-- /wp:column -->"""
BLOCKS = ["gps70-shell-block.html", "gps70-map-block.html", "gps70-sharing-block.html", "gps70-members-block.html", "gps70-alerts-sos-block.html"]
parts = []
for name in BLOCKS:
...
out = os.path.join(BASE, "gps70_payload.json")

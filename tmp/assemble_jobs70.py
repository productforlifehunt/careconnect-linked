...
BLOCKS = [
    "jobs70-shell-block.html",
    "jobs70-browse-block.html",
    "jobs70-applications-block.html",
    "jobs70-posted-block.html",
    "jobs70-modals-block.html",
]
...
out = os.path.join(BASE, "jobs70_payload.json")

  ...
  cct: {
    ...
    "161": {
      ...
      opt: {
        ...
        "CRAVING_SMOKING_CONTEXT": { "I_M_TAKING_A_BREAK": "b56", "OTHER": "b57" },
...
export const R = {
  ...
  /** 140. One care group can have one related group live chat conversation */
  careGroupConversation: 140,

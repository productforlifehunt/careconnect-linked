...
export default function AccompanieD() {
  return (
    <ContentHub
      ...
      titleZh="陪伴与支持"
      subtitle="Companionship options for your cared one — caregivers, remote companions, the in-app chat companion, and activity guides."
      subtitleZh="被护理者的陪伴方式——护理人员、远程陪伴、应用内聊天陪伴与活动指南。"

...
const variants: BrandVariant[] = [
  {
    ...
    heroTitle: "失智症照护，",
    heroHighlight: "智忆相连",
    heroSubtitle: "与家人协调失智症照护，找到专业护理人员，确保家人安全——一个团队，一个平台。",
  ...
  },
  {
    ...
    heroTitle: "失智症照护，",
    heroHighlight: "忆路相连",
    heroSubtitle: "连接家庭与专业护理，守护家人的每一段记忆——协调照护、追踪安全、温暖陪伴。",
    ctaTitle: "让记忆的纽带不再断裂",
    ctaSubtitle: "加入信任忆连的家庭，用爱与科技守护失智症家人。",
    ctaButton: "寻找失智症护理人员",
    ...
    badges: ["AI辅助失智症护理与陪伴", "背景调查", "GPS和走失警报", "AI辅助记录", "AI辅助定位"],
    steps: [
      { num: "1", title: "寻找专业帮助", desc: "浏览经过专业失智症培训的护理人员，让家人获得最适合的记忆照护支持。" },
      { num: "2", title: "团队协作", desc: "邀请家庭成员，分配任务，分享更新，共同守护家人的日常。" },
  ...
  },
  {
    ...
    badges: ["AI辅助失智症护理与陪伴", "背景调查", "GPS和走失警报", "AI辅助记录", "AI辅助定位"],
    steps: [
      { num: "1", title: "轻松找到帮助", desc: "浏览专业失智症护理人员，一键匹配最适合家人的照护方案。" },
  ...
  },
  {
    ...
    badges: ["AI辅助失智症护理与陪伴", "背景调查", "GPS和走失警报", "AI辅助记录", "AI辅助定位"],
    steps: [
      { num: "1", title: "召集战友", desc: "找到经过专业失智症训练的护理战士，与您并肩守护家人。" },

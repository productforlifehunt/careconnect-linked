...
/*
 * No settings live here. Every user setting is ONE skill (read + write in the
 * same entry) in src/lib/ai-dynamic-knowledge.ts, called by skill name from the
 * settings screen, the header, the language menu and the AI assistant alike.
 */

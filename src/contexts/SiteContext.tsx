...
const duoCareConfig: SiteConfig = {
  ...
  heroSubtitle: "DuoCare helps families find trusted caregivers, manage schedules, and stay connected with the people they care about.",
  ctaTitle: "Ready to arrange care with confidence?",
  ctaSubtitle: "Use DuoCare to find reliable support, compare options, and keep care organized in one place.",
  ctaButton: "Find Care",
  ...
  metaTitle: "DuoCare — Simple, trusted care",
  metaDescription: "Find trusted caregivers, manage bookings, and keep care organized with DuoCare.",

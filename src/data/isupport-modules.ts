...
export const ISUPPORT_MODULES: ISupportModule[] = [
  {
    ...
    descriptionZh: "什么是失智症，失智症患者会经历什么，以及当您怀疑被护理者有失智症时该怎么做。",
    icon: BookOpen,

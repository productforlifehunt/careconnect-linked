...
export const ISUPPORT_MODULES: ISupportModule[] = [
  {
    ...
    descriptionZh: "什么是失智症，失智症患者会经历什么，以及当您怀疑家人有失智症时该怎么做。",
    icon: BookOpen,
    ...
    lessons: [
      {
        ...
        reflectQuestionZh: "这里有一些失智症患者可能发生的常见情况。您认为您所照顾的家人/朋友/家人是否经历了以下任何一种情况？",
        quiz: {
    ...
    lessons: [
      {
        ...
        quiz: {
          ...
          correctIndices: [2],
          explanation: "Making mealtimes more pleasant often means helping the person stay involved in roles they still enjoy and can still do. Isolating them or forcing participation can increase withdrawal, while shared meal preparation or table tasks can preserve dignity, purpose, and connection.",
          explanationZh: "让用餐更愉快，往往意味着帮助当事人继续参与他们仍然喜欢、也仍然能够完成的角色。把他们隔离开来或强迫参与，可能会让他们更加退缩；共同准备饭菜或参与餐桌任务，更能维护尊严、价值感与连接感。",
      ...
      },
      {
        ...
        quiz: {
          ...
          explanation: "Improving eating in later dementia often means being flexible about timing, noticing patterns in what the person eats, and making preferred foods easy to access. These responses help carers support adequate food intake without creating unnecessary conflict or pressure.",
          explanationZh: "在失智症后期改善进食，往往意味着在用餐时间上保持灵活、观察当事人的进食规律，并让他们喜欢的食物更容易取得。这些做法能帮助护理者在不制造额外冲突或压力的情况下，支持足够的营养摄入。",
      ...
      },
      {
        ...
        quiz: {
          ...
          correctIndices: [0],
          explanation: "Personal care support works best when you help the person use the abilities they still have. Making items easy to find, simplifying steps, and offering respectful help protects dignity much better than taking over or criticizing them.",
          explanationZh: "个人护理支持最有效的方式，是帮助当事人继续使用他们仍然保有的能力。让用品更容易找到、简化步骤，并以尊重的方式提供协助，比直接接管或批评他们更能维护尊严。",
    ...
    lessons: [
      {
        ...
        quiz: {
          ...
          explanation: "Stressful behaviour is easier to manage when you notice what happened before it, pause before reacting, and choose responses that lower distress. Taking a breath, remembering the person is living with dementia, avoiding known triggers, and using practical aids can all help.",
          explanationZh: "当您留意行为发生前的情况、在回应前先停一下，并选择能降低痛苦的做法时，压力行为会更容易管理。深呼吸、提醒自己对方正与失智症共处、避免已知诱因，以及使用实际的小工具，都会有帮助。",

...
// ─── 5. Quote → hidden WooCommerce product ───
//    Implemented via the Code Snippets plugin (see snippet
//    "careconnect-quote-product") rather than here, per project rule:
//    operate WordPress plugins via GUI/snippets, not by editing plugin files.
